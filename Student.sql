...
INSERT INTO Course_Grades(CGID, Semester, CID_CG, SID_CG, Grade) VALUES(20221004,'SEM1',101003,34567,'A+');

SELECT * FROM Course_Grades

3. In the Student table, change the maximum length for Student first names to be 30
characters long.
...
UPDATE Course
SET Faculty_LName , C_Name='Intro to Wizardry' WHERE CID = 101001
...
10. Remove the foreign key constraints from CID and SID columns in the Course_Grades
table.
